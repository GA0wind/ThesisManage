...
public interface ProjectPlanMapper {
     ...
     * @mbg.generated Wed Mar 25 19:42:00 CST 2020
     */
    int updateByExampleSelective(@Param("record") ProjectPlan record,
        @Param("example") ProjectPlanExample example);
     ...
     * @mbg.generated Wed Mar 25 19:42:00 CST 2020
     */
    int updateByExample(@Param("record") ProjectPlan record,
        @Param("example") ProjectPlanExample example);
